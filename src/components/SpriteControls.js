...
const SpriteControls = () => {
  ...
  return (
    <div className="flex flex-col border-t-2 border-gray-900 bg-gray-800 p-2" style={{ flex: 0.2 }}>
      <div className="flex justify-between items-center mb-2">
        <p className="text-gray-400 font-bold text-lg">Sprites</p>
        <div className="flex gap-2">
          <div className="flex items-center justify-between py-2 px-4 bg-gray-700 rounded-lg shadow-md">
            <label htmlFor="enableCollision" className="text-gray-400 font-medium mr-4">
            ...
            <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out">
              ...
              <label
                ...
                className={`absolute top-0 left-0 right-0 bottom-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out ${spritesState.showCollisionAnimation ? 'bg-blue-600' : 'bg-gray-400'
                  }`}
              >
                <span
